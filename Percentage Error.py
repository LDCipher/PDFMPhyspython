...
def plot_data(xf_values, x_values, split_x, error, min_err, max_err, q_value, flavour_value, x, y, bezier):
    ...
    return (a1, b1, c1), (a2, b2, c2), residuals
...
def main():
    ...
    params_region1, params_region2, residuals = plot_data(xf_values, x_values, split_x, error, min_err, max_err,
                                                          q_value, flavour_value, x, y, popt)
    print(np.sum((residuals ** 2) / y))
